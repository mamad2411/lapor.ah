...
const features = [
  {
    number: "01",
    title: "Laporan Mudah & Cepat",
    description:
      "Isi formulir singkat, lampirkan foto, dan tentukan lokasi GPS. Tidak perlu antre di kantor desa—laporan terkirim dalam hitungan menit.",
    visual: "deploy",
  },
  {
    number: "02",
    ...
    description:
      "Pantau setiap tahap penanganan: diterima, ditinjau, dalam pengerjaan, hingga selesai. Anda selalu tahu perkembangan laporan Anda.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Kolaborasi RT/RW & Pemdes",
    description:
      "Laporan diteruskan ke unit yang tepat. RT/RW, sekdes, dan bidang terkait dapat berkoordinasi dalam satu sistem terpadu.",
    visual: "collab",
  },
  {
    number: "04",
    ...
    description:
      "Data warga dilindungi enkripsi. Opsi laporan anonim tersedia untuk kasus sensitif, dengan akses terbatas pada petugas berwenang.",
    visual: "security",
  },
];
...
// Pre-computed node positions to avoid floating point mismatch between SSR and client
const AI_NODES = [0, 1, 2, 3, 4, 5].map((i) => {
  const angle = (i * 60) * (Math.PI / 180);
  const radius = 50;
  return {
    x: parseFloat((100 + Math.cos(angle) * radius).toFixed(4)),
    y: parseFloat((80 + Math.sin(angle) * radius).toFixed(4)),
  };
});
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Semua yang warga butuhkan.
            <br />
            <span className="text-muted-foreground">Tanpa ribet.</span>
          </h2>
        </div>
